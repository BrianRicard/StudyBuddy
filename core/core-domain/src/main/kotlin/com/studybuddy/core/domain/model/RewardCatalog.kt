...
object RewardCatalog {
    ...
    val characters = listOf(
        ...
        // New expanded roster (batch 3) \u2014 common tier
        CharacterBody("raccoon", "Raccoon", "\uD83E\uDD9D"),
        CharacterBody("koala", "Koala", "\uD83D\uDC28"),
        CharacterBody("otter", "Otter", "\uD83E\uDDA6"),
        CharacterBody("sloth", "Sloth", "\uD83E\uDDA5"),
        CharacterBody("hedgehog", "Hedgehog", "\uD83E\uDD94"),
        CharacterBody("flamingo", "Flamingo", "\uD83E\uDDA9"),
        // Rare tier
        CharacterBody("red_panda", "Red Panda", "\uD83D\uDC3C"),
        CharacterBody("narwhal", "Narwhal", "\uD83D\uDC0B"),
        CharacterBody("axolotl", "Axolotl", "\uD83E\uDD8E"),
        CharacterBody("peacock", "Peacock", "\uD83E\uDD9A"),
        CharacterBody("arctic_fox", "Arctic Fox", "\uD83E\uDD8A"),
        CharacterBody("dolphin", "Dolphin", "\uD83D\uDC2C"),
        // Epic tier \u2014 costume skins
        CharacterBody("astronaut_koala", "Astronaut Koala", "\uD83D\uDC28"),
        CharacterBody("chef_raccoon", "Chef Raccoon", "\uD83E\uDD9D"),
        CharacterBody("explorer_sloth", "Explorer Sloth", "\uD83E\uDDA5"),
        CharacterBody("knight_hedgehog", "Knight Hedgehog", "\uD83E\uDD94"),
        CharacterBody("pilot_narwhal", "Pilot Narwhal", "\uD83D\uDC0B"),
        CharacterBody("artist_flamingo", "Artist Flamingo", "\uD83E\uDDA9"),
        CharacterBody("scientist_axolotl", "Scientist Axolotl", "\uD83E\uDD8E"),
        // Legendary tier \u2014 new mythic creatures
        CharacterBody("crystal_stag", "Crystal Stag", "\uD83E\uDD8C"),
        CharacterBody("thunder_ram", "Thunder Ram", "\uD83D\uDC0F"),
        CharacterBody("moon_wolf", "Moon Wolf", "\uD83D\uDC3A"),
        CharacterBody("golden_griffin", "Golden Griffin", "\uD83E\uDD85"),
        CharacterBody("abyss_kraken", "Abyss Kraken", "\uD83D\uDC19"),
        CharacterBody("mythic_pegasus", "Mythic Pegasus", "\uD83E\uDD84"),
    )
    ...
    val characterItems = listOf(
        ...
        // Common
        RewardItem("char_raccoon", RewardCategory.CHARACTER, "Raccoon", "\uD83E\uDD9D", 45, AvatarTier.COMMON),
        RewardItem("char_koala", RewardCategory.CHARACTER, "Koala", "\uD83D\uDC28", 50, AvatarTier.COMMON),
        RewardItem("char_otter", RewardCategory.CHARACTER, "Otter", "\uD83E\uDDA6", 55, AvatarTier.COMMON),
        RewardItem("char_sloth", RewardCategory.CHARACTER, "Sloth", "\uD83E\uDDA5", 55, AvatarTier.COMMON),
        RewardItem("char_hedgehog", RewardCategory.CHARACTER, "Hedgehog", "\uD83E\uDD94", 60, AvatarTier.COMMON),
        RewardItem("char_flamingo", RewardCategory.CHARACTER, "Flamingo", "\uD83E\uDDA9", 65, AvatarTier.COMMON),
        // Rare
        RewardItem("char_red_panda", RewardCategory.CHARACTER, "Red Panda", "\uD83D\uDC3C", 130, AvatarTier.RARE),
        RewardItem("char_narwhal", RewardCategory.CHARACTER, "Narwhal", "\uD83D\uDC0B", 140, AvatarTier.RARE),
        RewardItem("char_axolotl", RewardCategory.CHARACTER, "Axolotl", "\uD83E\uDD8E", 150, AvatarTier.RARE),
        RewardItem("char_peacock", RewardCategory.CHARACTER, "Peacock", "\uD83E\uDD9A", 160, AvatarTier.RARE),
        RewardItem("char_arctic_fox", RewardCategory.CHARACTER, "Arctic Fox", "\uD83E\uDD8A", 175, AvatarTier.RARE),
        RewardItem("char_dolphin", RewardCategory.CHARACTER, "Dolphin", "\uD83D\uDC2C", 190, AvatarTier.RARE),
        // Epic \u2014 costume skins of the species above
        RewardItem(
            "char_astronaut_koala",
            RewardCategory.CHARACTER,
            "Astronaut Koala",
            "\uD83D\uDC28",
            320,
        ...
        // Legendary \u2014 new mythic creatures, no base-tier counterpart
        RewardItem(
            "char_crystal_stag",
            RewardCategory.CHARACTER,
            "Crystal Stag",
