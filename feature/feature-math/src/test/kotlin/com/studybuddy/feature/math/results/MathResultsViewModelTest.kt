...
class MathResultsViewModelTest {
    ...
    @Test
    fun `initial state calculates accuracy correctly`() =
        runTest {
    ...
    @Test
    fun `initial state shows correct totals`() =
        runTest {
    ...
    @Test
    fun `streak master badge awarded for streak of 10 or more`() =
        runTest {
    ...
    @Test
    fun `streak master badge not awarded for streak below 10`() =
        runTest {
    ...
    @Test
    fun `speed demon badge awarded for fast avg response time`() =
        runTest {
    ...
    @Test
    fun `speed demon badge not awarded for slow response time`() =
        runTest {
    ...
    @Test
    fun `navigate home emits NavigateToHome effect`() =
        runTest {
            val viewModel = createViewModel()
            advanceUntilIdle()
    ...
    @Test
    fun `play again emits NavigateToSetup effect`() =
        runTest {
            val viewModel = createViewModel()
            advanceUntilIdle()
    ...
    @Test
    fun `consume effect clears effect`() =
        runTest {
            val viewModel = createViewModel()
            advanceUntilIdle()
    ...
    @Test
    fun `session is saved on initialization`() =
        runTest {
            createViewModel()
            advanceUntilIdle()
    ...
    @Test
    fun `points are awarded on initialization`() =
        runTest {
            createViewModel()
            advanceUntilIdle()
    ...
    @Test
    fun `zero total problems results in zero accuracy`() =
        runTest {
    ...
    @Test
    fun `total points includes session score and streak bonus`() =
        runTest {
