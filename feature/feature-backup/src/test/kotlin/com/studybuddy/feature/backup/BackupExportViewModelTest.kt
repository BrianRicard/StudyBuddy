...
class BackupExportViewModelTest {
    ...
    @Test
    fun `create backup sets success state and emits effect`() =
        runTest {
    ...
    @Test
    fun `create backup sets error on failure`() =
        runTest {
    ...
    @Test
    fun `start restore shows confirmation dialog`() =
        runTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `dismiss restore dialog clears state`() =
        runTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `confirm restore calls use case and sets success`() =
        runTest {
    ...
    @Test
    fun `confirm restore sets error on failure`() =
        runTest {
    ...
    @Test
    fun `export pdf calls use case and emits share effect`() =
        runTest {
    ...
    @Test
    fun `export json calls create backup and emits share effect`() =
        runTest {
            coEvery { createBackupUseCase() } returns "{\"version\":1}"
            val viewModel = createViewModel()
    ...
    @Test
    fun `export csv calls use case and emits share effect`() =
        runTest {
    ...
    @Test
    fun `dismiss status clears messages`() =
        runTest {
    ...
    @Test
    fun `set auto backup enabled updates state`() =
        runTest {
            val viewModel = createViewModel()
    ...
    @Test
    fun `set auto backup frequency updates state`() =
        runTest {
            val viewModel = createViewModel()
